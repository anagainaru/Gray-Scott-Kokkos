...
{
    Kokkos::View<double ***, MemSpace> u2("TempU", simComm.size_x + 2, simComm.size_y + 2, simComm.size_z + 2);
    Kokkos::View<double ***, MemSpace> v2("TempV", simComm.size_x + 2, simComm.size_y + 2, simComm.size_z + 2);
